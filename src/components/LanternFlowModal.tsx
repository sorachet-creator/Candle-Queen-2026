                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center gap-4">
                      <motion.a
                        href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}&quote=${encodeURIComponent('ข้าพเจ้าได้ร่วมจุดโคมลอยถวายความอาลัยแด่สมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ พระบรมราชชนนีพันปีหลวง')}`}
                        target="_blank"
                      ...
                      <motion.a
                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('ข้าพเจ้าได้ร่วมจุดโคมลอยถวายความอาลัยแด่สมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ พระบรมราชชนนีพันปีหลวง')}&url=${encodeURIComponent(window.location.href)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      <motion.a
                        href={`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent('ข้าพเจ้าได้ร่วมจุดโคมลอยถวายความอาลัยแด่สมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ พระบรมราชชนนีพันปีหลวง')}`}
                        target="_blank"
                        rel="noopener noreferrer"
